...
describe('dedupe', () => {
  ...
  it('should remove multiple dupicates', () => {
  ...
  it('should remove value of the key is "a"', () => {
    let deduped = dedupe([{a: 1, b: 1}, {a: 1, b: 2}, {a: 1, c: 3}], v => v.a)

    expect(deduped).to.deep.equal([{a: 1, b: 1}])
  })
})
